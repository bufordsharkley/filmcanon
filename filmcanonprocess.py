...
#TODO: split into functional data module and Tkinter module

# seems to be wholly graphical:
...
class ComparisonWidget(Frame):
    ...
    def __init__(self, master):
        ...
        # inheritance? modifications for scrollbar/selectall are needed everywhere...
    ...
    # readable? that's data module.    (this is way too specific... needs to be generalized)
...
# the dashboard itself should be graphical...
